...
if __name__ == '__main__':
    ...
    lfnn = FCNN_DE(1, 5*2, [16, 16, 16], activation=torch.nn.Tanh, low_fidelity_features=4)
    print("lfnn", lfnn)
    y_high, y_high_variance = lfnn(x, y_low)
    print("y_high", y_high, y_high_variance)