...
plt.plot(ft_rope_loss_train, "--r", label="Attention-Rope Train")
plt.plot(ft_rope_loss_test, "-r", label="Attention-Rope Test")
...
plt.plot(ft_loss_train, "--b", label="Attention Train")
plt.plot(ft_loss_test, "-b", label="Attention Test")
