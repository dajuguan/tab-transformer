...
class MySimpleMLP(nn.Module):
    ...
    **Example**::
    ...
    def forward(self, x):
        ...
        mean, variance = torch.split(x, int(self._output_size/2), dim=-1)
...
model_path = "./data/mlp_de_stacking.model"
loss_path = "./data/mlp_de_stacking.loss"
...
if __name__ == "__main__":
    ...
    y_pred, y_variance = model(x_test)
